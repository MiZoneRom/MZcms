...
namespace MZcms.Web.Areas.Admin.Controllers
{
    public class PrivilegeController : BaseAdminController
    {
        ...
        public ActionResult Edit(long id)
        {
            ...
            ViewBag.RolePrivilegeInfo = Newtonsoft.Json.JsonConvert.SerializeObject(model.ManagerPrivileges.Select(item => new { Privilege = item.Privilege }), s);
            return View(result);
        }
        ...
        public JsonResult Edit(string roleJson, long id)
        {
            if (ModelState.IsValid)
            {
                ...
                ManagersRoles role = Newtonsoft.Json.JsonConvert.DeserializeObject<ManagersRoles>(roleJson, s);
                role.Id = id;

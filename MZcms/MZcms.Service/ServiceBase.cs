...
namespace MZcms.Service
{
    public class ServiceBase
    {
        ...
        #region 属性
        protected MZcms.Entity.Entities Context
        {
            get
            {
                ...
                var entities = CallContext.GetData(name) as MZcms.Entity.Entities;
        ...
        /// 没有延迟加载，没有代理的上下文
        /// </summary>
        protected MZcms.Entity.Entities NoLazyNoProxyContext
        {
            get
            {
